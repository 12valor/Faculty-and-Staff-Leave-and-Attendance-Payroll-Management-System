...
export default async function DashboardPage() {
  ...
  const [totalEmployees, facultyCount, scheduledEmployees, todayRecords, pendingLeave, approvedLeave, rejectedLeave, attendanceRows, deduction, deductions, payrollPeriod] = await Promise.all([
